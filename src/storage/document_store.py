...
class DocumentStore:
    ...
    async def store_document(self, document: dict[str, Any]) -> str:
        ...
        try:
            ...
            logging.exception(f"❌ Chyba při ukládání dokumentu: {e}")
            raise
    ...
    async def get_document(self, doc_id: str) -> dict[str, Any] | None:
        ...
        try:
            ...
            logging.exception(f"❌ Chyba při načítání dokumentu {doc_id}: {e}")
            return None
    ...
    async def search_documents(self, query: str, limit: int = 10) -> list[dict[str, Any]]:
        ...
        try:
            ...
            logging.exception(f"❌ Chyba při vyhledávání: {e}")
            return []
    ...
    async def get_documents_by_source(self, source: str) -> list[dict[str, Any]]:
        ...
        try:
            ...
            logging.exception(f"❌ Chyba při načítání dokumentů ze zdroje {source}: {e}")
            return []
    ...
    async def get_recent_documents(self, limit: int = 10) -> list[dict[str, Any]]:
        ...
        try:
            ...
            logging.exception(f"❌ Chyba při načítání nejnovějších dokumentů: {e}")
            return []
    ...
    async def update_document_metadata(self, doc_id: str, updates: dict[str, Any]) -> bool:
        ...
        try:
            ...
            logging.exception(f"❌ Chyba při aktualizaci metadat {doc_id}: {e}")
            return False
    ...
    async def delete_document(self, doc_id: str) -> bool:
        ...
        try:
            ...
            logging.exception(f"❌ Chyba při mazání dokumentu {doc_id}: {e}")
            return False
    ...
    def get_stats(self) -> dict[str, Any]:
        ...
        try:
            ...
            logging.exception(f"❌ Chyba při získávání statistik: {e}")
            return {}
    ...
    async def _save_index(self):
        ...
        try:
            ...
            logging.exception(f"❌ Chyba při ukládání indexu: {e}")
    ...
    async def cleanup_old_documents(self, days: int = 30) -> int:
        ...
        try:
            ...
            logging.exception(f"❌ Chyba při čištění dokumentů: {e}")
            return 0
