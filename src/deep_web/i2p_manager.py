...
class I2PSession:
    ...
    async def create_stream(self, destination: str) -> Optional[asyncio.StreamReader]:
...
class I2PManager:
    ...
    async def resolve_i2p_address(self, address: str) -> Optional[str]:
...
__all__ = ["I2PManager", "I2PConfig", "I2PSession", "test_i2p_connection", "setup_i2p_environment"]
