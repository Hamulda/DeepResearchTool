...
LANGGRAPH_CONFIG = {
    ...
    "llm": {
        ...
        "api_key": os.getenv("OPENAI_API_KEY"),  # API klíč z prostředí
    },
    ...
    "security": {
        ...
        "blocked_domains": ["facebook.com", "twitter.com", "instagram.com"],  # Zakázané domény
...
RESEARCH_PROFILES = {
    "quick": {
        ...
        "llm": {"model": "gpt-4o-mini", "max_tokens": 2000},
        "rag": {"retrieval": {"k": 3, "max_context_tokens": 2000}},
        "synthesis": {"max_docs": 5, "max_claims": 3},
        "validation": {"min_relevance": 0.6, "min_coverage": 0.5},
    },
    "thorough": {
        # Důkladný profil pro kompletní analýzu
        "llm": {"model": "gpt-4o", "max_tokens": 8000},
        "rag": {"retrieval": {"k": 10, "max_context_tokens": 8000}},
        "synthesis": {"max_docs": 15, "max_claims": 10},
        "validation": {"min_relevance": 0.8, "min_coverage": 0.7},
    },
    "academic": {
        # Akademický profil s vysokými nároky na citace
        "llm": {"model": "gpt-4o", "synthesis_model": "gpt-4o", "temperature": 0.05},
        "synthesis": {"min_citations_per_claim": 3, "max_claims": 12, "include_metadata": True},
        "validation": {"min_relevance": 0.85, "min_coverage": 0.8, "min_quality": 0.7},
    },
}
